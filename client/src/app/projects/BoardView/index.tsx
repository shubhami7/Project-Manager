import { Task as TaskType, useGetTasksQuery, useUpdateTaskStatusMutation } from '@/src/state/api';
    ...
    return (
        ...
        >
            <div className='mb-3 flex w-full'>
                <div className={`w-2 ${statusColor[status]} rounded-s-lg`} 
                />
                <div className='flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-gray-900'>
                    ...
                    <div className='flex items-center gap-1'>
                        <button className='flex h-6 w-5 items-center justify-center dark:text-neutral-400'>
                            <EllipsisVertical size={26} />
                        </button>
                        <button className='flex h-6 w-6 items-center justify-center rounded bg-gray-200 dark:bg-gray-600 dark:text-white'
...
const Task = ({task}: TaskProps) => {
    ...
    return (
        ...
        className={`mb-4 rounded-md bg-white shadow dark:bg-gray-900 ${
        ...
        >
            ...
            <div className='p-4 md:p-6'>
                <div className='flex items-start justify-between'>
                    ...
                    <button className='flex h-6 w-4 flex-shrink-0 items-center justify-center dark:text-neutral-400'>
                        <EllipsisVertical size={26} />
                    </button>
                </div>
                    ...
                    <div className='flex -space-x=[6px] overflow-hidden'>
                        {task.assignee && (
                            <Image
                                ...
                                width={30}
                                height={30}
                                className="h-8 w-8 rounded-full border-2 border-white object-cover dark:border-gray-950"
                            />
                        )}
                        {task.author && (
                            <Image
