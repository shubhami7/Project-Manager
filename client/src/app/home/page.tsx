...
import { Priority, Project, Task, useGetProjectsQuery, useGetTasksQuery } from '@/src/state/api';
    ...
    <div className='container h-full w-[100%]bg-gray-100 bg-transparent p-8'>
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
            ...
            <div className='rounded-lg bg-white p-4 shadow dark:bg-gray-900'>
                ...
                <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                        <Pie dataKey="count" data={projectStatus} fill='#82ca29d' label>
            ...
            <div className='rounded-lg bg-white p-4 shadow dark:bg-gray-900 md:col-span-2'>
                <h3 className='mb-4 text-lg font-semibold dark:text-white'>
                    Your Tasks
                </h3>
