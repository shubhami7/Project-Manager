...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between bg-white px-4 py-3 dark:bg-black h-[56px]'>
        {/**Search Bar */}
        <div className='flex items-center gap-8'>
            ...
            <div className='relative flex flex-col h-min w-[200px]'>
                <Search className='absolute left-[4px] top-2 mr-2 h-5 w-5 -translate-y-1/2 transform cursor-pointer dark:text-white' />
                <input 
